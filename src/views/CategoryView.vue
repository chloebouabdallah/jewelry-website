...
// Define all products by category with filter properties
const productsByCategory = {
  necklaces: [
    { id: 1, name: 'Celestial Diamond Necklace', price: 3850, image: '/necklace2.webp', metal: 'Gold', gemstone: 'Diamond', badge: 'Best Seller', metalFilter: 'gold', priceRange: '3000-plus', gemFilter: 'diamond', styleFilter: 'classic' },
    { id: 2, name: 'Silver Diamond Pendant', price: 2450, image: '/necklace3.jpg', metal: 'Silver', gemstone: 'Diamond', badge: 'New', metalFilter: 'silver', priceRange: '1500-3000', gemFilter: 'diamond', styleFilter: 'modern' },
    { id: 3, name: 'Gold Necklace', price: 1890, image: '/necklace4.jpg', metal: 'Gold', gemstone: 'None', badge: null, metalFilter: 'gold', priceRange: '1500-3000', gemFilter: 'none', styleFilter: 'minimalist' },
    { id: 4, name: 'Gold Necklace', price: 5290, image: '/necklace5.jpg', metal: 'Gold', gemstone: 'None', badge: 'Limited', metalFilter: 'gold', priceRange: '3000-plus', gemFilter: 'none', styleFilter: 'classic' },
    { id: 5, name: 'Gold Diamond Necklace', price: 5290, image: '/necklace6.jpg', metal: 'Gold', gemstone: 'Diamond', badge: 'Limited', metalFilter: 'gold', priceRange: '3000-plus', gemFilter: 'diamond', styleFilter: 'vintage' },
    { id: 6, name: 'Silver Diamond Necklace', price: 5290, image: '/necklace7.jpg', metal: 'Silver', gemstone: 'Diamond', badge: 'Limited', metalFilter: 'silver', priceRange: '3000-plus', gemFilter: 'diamond', styleFilter: 'classic' }
  ],
  earrings: [
    { id: 101, name: 'Gold Earrings', price: 5290, image: '/earring1.avif', metal: 'Gold', gemstone: 'None', badge: 'Best Seller', metalFilter: 'gold', priceRange: '3000-plus', gemFilter: 'none', styleFilter: 'classic' },
    { id: 102, name: 'Rose Gold Diamond Earrings', price: 1890, image: '/earring2.jpg', metal: 'Rose Gold', gemstone: 'Diamond', badge: 'New', metalFilter: 'rose-gold', priceRange: '1500-3000', gemFilter: 'diamond', styleFilter: 'modern' },
    { id: 103, name: 'Rose Gold Diamond Hoops', price: 890, image: '/earring3.jpg', metal: 'Rose Gold', gemstone: 'Diamond', badge: null, metalFilter: 'rose-gold', priceRange: '500-1500', gemFilter: 'diamond', styleFilter: 'minimalist' },
    { id: 104, name: 'Gold Diamond Studs', price: 2450, image: '/earring4.jpg', metal: 'Gold', gemstone: 'Diamond', badge: 'Limited', metalFilter: 'gold', priceRange: '1500-3000', gemFilter: 'diamond', styleFilter: 'classic' },
    { id: 105, name: 'Gold Earrings', price: 2450, image: '/earring5.jpg', metal: 'Gold', gemstone: 'None', badge: 'Limited', metalFilter: 'gold', priceRange: '1500-3000', gemFilter: 'none', styleFilter: 'vintage' },
    { id: 106, name: 'Gold Earrings', price: 2450, image: '/earring6.jpg', metal: 'Gold', gemstone: 'None', badge: 'Limited', metalFilter: 'gold', priceRange: '1500-3000', gemFilter: 'none', styleFilter: 'modern' }
  ],
  rings: [
    { id: 201, name: 'Silver Diamond Ring', price: 2975, image: '/ring1.jpg', metal: 'Silver', gemstone: 'Diamond', badge: 'Best Seller', metalFilter: 'silver', priceRange: '1500-3000', gemFilter: 'diamond', styleFilter: 'classic' },
    { id: 202, name: 'Rose Gold Morganite Ring', price: 1590, image: '/ring2.webp', metal: 'Rose Gold', gemstone: 'Morganite', badge: 'New', metalFilter: 'rose-gold', priceRange: '1500-3000', gemFilter: 'morganite', styleFilter: 'modern' },
    { id: 203, name: 'Silver Diamond Ring', price: 2250, image: '/ring3.jpg', metal: 'Silver', gemstone: 'Diamond', badge: null, metalFilter: 'silver', priceRange: '1500-3000', gemFilter: 'diamond', styleFilter: 'classic' },
    { id: 204, name: 'Gold Ring', price: 3450, image: '/ring4.jpg', metal: 'Gold', gemstone: 'None', badge: 'Limited', metalFilter: 'gold', priceRange: '3000-plus', gemFilter: 'none', styleFilter: 'classic' },
    { id: 205, name: 'Gold Ring', price: 450, image: '/ring5.jpg', metal: 'Gold', gemstone: 'None', badge: null, metalFilter: 'gold', priceRange: 'under-500', gemFilter: 'none', styleFilter: 'minimalist' },
    { id: 206, name: 'Gold Diamond Ring', price: 2450, image: '/ring6.jpg', metal: 'Gold', gemstone: 'Diamond', badge: 'Limited', metalFilter: 'gold', priceRange: '1500-3000', gemFilter: 'diamond', styleFilter: 'vintage' }
  ],
  bracelets: [
    { id: 301, name: 'Silver Diamond Bracelet', price: 299, image: '/bracelet1.webp', metal: 'Silver', gemstone: 'Diamond', badge: 'Best Seller', metalFilter: 'silver', priceRange: 'under-500', gemFilter: 'diamond', styleFilter: 'classic' },
    { id: 302, name: 'Gold Diamond Tennis Bracelet', price: 2890, image: '/bracelet2.jpg', metal: 'Gold', gemstone: 'Diamond', badge: 'New', metalFilter: 'gold', priceRange: '1500-3000', gemFilter: 'diamond', styleFilter: 'classic' },
    { id: 303, name: 'Gold Diamond Chain Bracelet', price: 590, image: '/bracelet3.jpg', metal: 'Gold', gemstone: 'Diamond', badge: null, metalFilter: 'gold', priceRange: '500-1500', gemFilter: 'diamond', styleFilter: 'modern' },
    { id: 304, name: 'Silver Diamond Bracelet', price: 450, image: '/bracelet4.jpg', metal: 'Silver', gemstone: 'Diamond', badge: 'Limited', metalFilter: 'silver', priceRange: 'under-500', gemFilter: 'diamond', styleFilter: 'vintage' },
    { id: 305, name: 'Silver Diamond Bracelet', price: 450, image: '/bracelet5.jpg', metal: 'Silver', gemstone: 'Diamond', badge: 'Limited', metalFilter: 'silver', priceRange: 'under-500', gemFilter: 'diamond', styleFilter: 'minimalist' },
    { id: 306, name: 'Silver Diamond Bracelet', price: 450, image: '/bracelet6.jpg', metal: 'Silver', gemstone: 'Diamond', badge: 'Limited', metalFilter: 'silver', priceRange: 'under-500', gemFilter: 'diamond', styleFilter: 'classic' }
  ]
}
